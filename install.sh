...
# Variables
# ================================
PASSWALL_INSTALL_DIR="/root/free-internet/passwall2"
PASSWALL_BIN_DIR="/usr/bin/passwall2"
PASSWALL_COMMAND="passwall2"
...
if [ ! -d "$PASSWALL_INSTALL_DIR" ]; then
    echo "[INFO] Cloning Passwall 2 repository to $PASSWALL_INSTALL_DIR"
    git clone "$REPO_URL" "$PASSWALL_INSTALL_DIR" || { echo "[ERROR] Failed to clone repo"; exit 1; }
else
    echo "[INFO] Updating Passwall 2 repository at $PASSWALL_INSTALL_DIR"
